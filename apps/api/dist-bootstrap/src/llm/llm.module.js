...
const disabled_llm_provider_1 = require("./disabled-llm.provider");
...
exports.LlmModule = LlmModule = __decorate([
    (0, common_1.Module)({
        providers: [
            disabled_llm_provider_1.DisabledLlmProvider,
            {
                provide: llm_provider_1.LLM_PROVIDER,
                useExisting: disabled_llm_provider_1.DisabledLlmProvider,
            },
