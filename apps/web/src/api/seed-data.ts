...
const docKazhydromet202509: SourceDocument = {
  ...
  title: 'Информационный бюллетень о состоянии окружающей среды: Атырауская область, сентябрь 2025',
...
const docKazhydromet202505: SourceDocument = {
  ...
  title: 'Информационный бюллетень о состоянии окружающей среды: Атырауская область, май 2025',
  publisher: 'РГП «Казгидромет»',
...
const mSep1kmAbove = measurement('m-2025-09-1km-above-atyrau', stZhaiyk1kmAboveAtyrau, SEPTEMBER_2025, 0.234, docKazhydromet202509.id, SEPTEMBER_PAGE);
const mSepAsaAbove = measurement('m-2025-09-asa-above', stAsa05kmAbove, SEPTEMBER_2025, 0.058, docKazhydromet202509.id, SEPTEMBER_PAGE);
const mSepAsaBelow = measurement('m-2025-09-asa-below', stAsa05kmBelow, SEPTEMBER_2025, 0.054, docKazhydromet202509.id, SEPTEMBER_PAGE);
const mSep1kmBelow = measurement('m-2025-09-1km-below-atyrau', stZhaiyk1kmBelowAtyrau, SEPTEMBER_2025, 0.167, docKazhydromet202509.id, SEPTEMBER_PAGE);
const mSepSturgeonAbove = measurement('m-2025-09-sturgeon-above', stSturgeon05kmAbove, SEPTEMBER_2025, 0.066, docKazhydromet202509.id, SEPTEMBER_PAGE);
const mSepSturgeonBelow = measurement('m-2025-09-sturgeon-below', stSturgeon3kmBelow, SEPTEMBER_2025, 0.063, docKazhydromet202509.id, SEPTEMBER_PAGE);
const mSepDamba = measurement('m-2025-09-damba', stDamba, SEPTEMBER_2025, 0.067, docKazhydromet202509.id, SEPTEMBER_PAGE);

const mMayAsaAbove = measurement('m-2025-05-asa-above', stAsa05kmAbove, MAY_2025, 0.114, docKazhydromet202505.id, MAY_PAGE);
const mMayAsaBelow = measurement('m-2025-05-asa-below', stAsa05kmBelow, MAY_2025, 0.193, docKazhydromet202505.id, MAY_PAGE);
...
export const incidentDetails: Record<string, IncidentDetail> = {
  [invSeptember.id]: {
    ...
    sourceDocuments: [docKazhydromet202509, docZakonGreenWater, docKazinformWastewater, docAkZhaiykOilFilm],
    corridorBounds: {
    ...
    steps: [
      ...
      },
      {
        ...
        payload: {
          ...
          measurements: [mSep1kmAbove, mSepAsaAbove, mSepAsaBelow, mSep1kmBelow],
          evidenceLevel: 'L1',
        },
      },
      {
...
export const evidenceGraphs: Record<string, { statements: EvidenceStatement[]; measurements: Measurement[]; sourceDocuments: SourceDocument[] }> = {
  [invSeptember.id]: {
...
export const liveStatusSeed: LiveStatus = {
  sources: [
    { id: 'kazhydromet-bulletins', name: 'Казгидромет: ежемесячные бюллетени', lastSuccessAt: null, cacheAvailable: true },
    { id: 'gdelt', name: 'GDELT DOC 2.0', lastSuccessAt: null, cacheAvailable: false },
    { id: 'open-meteo-flood', name: 'Open-Meteo Flood API (расход Жайыка)', lastSuccessAt: null, cacheAvailable: false },
    { id: 'open-meteo-marine', name: 'Open-Meteo Marine API (волны у Актау)', lastSuccessAt: null, cacheAvailable: false },
  ],
};
