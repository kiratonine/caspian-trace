...
const invSeptember: Investigation = {
  ...
  conclusion:
    "КГП 'Атырау су арнасы' не причастно. с 79% вероятностью источник загрязнения Коктем Дача. Доступные факты не поддерживают локальную версию ниже максимума; поиск следует продолжать выше створа «1 км выше Атырау».",
  updatedAt: SEEDED_AT,
}
