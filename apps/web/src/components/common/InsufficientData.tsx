 ...
 */
export function InsufficientData({ reasons, className }: InsufficientDataProps) {
  return (
    <section
      role="status"
      className={cn(
        'flex flex-col gap-4 border border-dashed p-6',
        className,
      )}
    >
      <div className="flex items-center gap-2.5">
        <SearchX aria-hidden className="size-5 shrink-0 text-muted-foreground" />
