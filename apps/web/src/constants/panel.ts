...
// Блок хранит утверждения правил, а не сами измерения: «установленных фактов
// нет» рядом с семью подтверждёнными значениями на схеме было бы неправдой.
export const PANEL_NO_FACTS =
  "Подтверждающих утверждений расчётное ядро не выпустило."
