...
**Сессия 4 (04.08.2026) — common-примитивы + lib/format. Завершена.**
...
- **Следующая задача (сессия 5): линейная схема реки v1** на сентябрьских данных,
  числа кликабельны через `MeasurementValue` (контрольная точка 12 ч). Вопрос 1
  (порядок створов) всё ещё открыт → у всех станций `riverOrder = null`, схема
  честно покажет группу «порядок не подтверждён» (`UnorderedStations`) —
  реализовать обе ветки, чтобы ответ команды включил линию без переделки.
...
- [ ] Линейная схема реки v1 на сентябрьских данных, числа кликабельны. ← СЛЕДУЮЩАЯ (сессия 5)
